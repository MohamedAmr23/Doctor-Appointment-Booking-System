...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className='pb-3 mt-12 text-lg font-medium text-gray-600 border-b'></p>
      <div>
          ...
          <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
            ...
            <div className='flex-1 text-sm text-[#5E5E5E]'>
              ...
              <p className='mt-1 text-xs'>
                <span className='text-sm text-[#3C3C3C] font-medium'>Date & Time:</span>22 undefined 2025 | 10:00 AM
              </p>
              </div>
              <div></div>
